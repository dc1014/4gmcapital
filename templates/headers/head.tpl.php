<head>
    ...
    <?php if ($responsive){?>
    	...
    	<link id="link-color-r" href="css/color/<?php echo $theme_color ?>-responsive.css" rel="stylesheet" type="text/css">        
		<?php if (isset($specific_css) && $specific_css != '') { ?>
...
<body class="<?php if ($boxed) echo 'boxed'; ?> <?php if (isset($background)) echo $background; ?> clearfix" data-smooth-scrolling="1"><?php include_once("analyticstracking.php") ?>